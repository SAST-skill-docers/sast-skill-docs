...
!!! question "Hello World!"
	...
	**[Checkpoint Python-01] Hello World**
	...
	(1) 请尝试在控制台使用交互式窗口方式，使程序输出 ${"Hello, " + 你的名字 + "!"}。如 "Hello, c7w!"
...
!!! question "Python 运算体验"
	...
	**[Checkpoint Python-02] Operators**
	...
	$1\degree a = 10^{2000}-1$
	
	$2\degree a = 11451419198101919810114514 * 11451419198101919810114514$
	
	$3\degree a = 10^{-200} * 10^{-400}$
...
!!! note "小明的 Magic Editor"

	**[Checkpoint Python-04] MagicEditor**
	
	(1)【文本的写入】
	
	使用 Python 在相对路径下的 'ans1.txt' 中写入以下内容：
	```
	这是第 1 条数据
	这是第 2 条数据
	...(9997 lines)...
	...
	(2)【文本去重】
	读取 'ans1.txt' 中的内容，将相同的行去重后，输出为 'ans2.txt'. （不要求顺序完全相同）
